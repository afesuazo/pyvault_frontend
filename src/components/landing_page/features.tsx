...
const Features = ({isLockHovered}: FeaturesProps) => {
    ...
    const [titleTexts, setTitleTexts] = useState(features.map(feature => feature.title));
    const [descriptionTexts, setDescriptionTexts] = useState(features.map(feature => feature.description));
